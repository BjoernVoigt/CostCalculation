...
from GeneticAlgorithmBBox import GeneticAlgorithm
...
class STEPAnalyzer(QMainWindow):
    ...
    def analyze_step_file(self, file_path):
        try:
            ...
            ga = GeneticAlgorithm()
            bbox = ga.opti_bbox(file_path, pop_size=10000, itermax=15)
            self.main_app.dimensions = sorted(bbox, reverse=True)
